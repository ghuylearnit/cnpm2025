...
// View engine (nếu bạn dùng Pug cho vài trang)
...
app.use(bodyParser.urlencoded({ extended: true })); // có thể bỏ nếu đã dùng express.urlencoded
app.use(cookieParser());
app.use(fileUpload());

// ========== Mount routes ==========
// tuỳ cấu trúc file route của bạn, giữ giống như bản obfuscate đã mount
app.use('/api/v1',            foodRouter);
app.use('/api/v1/eats',       menuRouter);            // ⭐ để có /api/v1/eats/stores/:id/menus
